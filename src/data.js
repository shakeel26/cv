export const personalData = {
  ...
  contacts: {
    website: 'https://firmen.wko.at/shakeel-ahmed-msc/tirol/',
...
export const skills = ['React', 'Javascript', 'CSS', 'SQL', 'SomeTech', 'CoolTech']

export const hobbies = ['Photography', 'Poetry']