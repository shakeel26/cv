...
export const CVData = {
  personalData: {
    ...
    detail: 'test 2',
    image: 'https://www.sti-innsbruck.at/sites/default/files/images/members/shakeel.png',
    contacts: [
      { type: 'website', value: 'https://firmen.wko.at/shakeel-ahmed-msc/tirol/' },
      { type: 'email', value: 'shakeel.uibk@gmail.com' },
      { type: 'phone', value: '+43 660 755 3781' },
      { type: 'location', value: 'Innsbruck, Austria' },
      { type: 'linkedin', value: 'https://www.linkedin.com/in/shakeel26/' },
      { type: 'github', value: 'https://github.com/shakeel26/' }
    ]
  },
  sections: [
    {
